...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiCreatedResponse)({ description: "Ajout d'un article avec succès." }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOkResponse)({ description: 'Retour des articles avec succès.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Accès refusé.' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOkResponse)({ description: "Retour d'un article avec succès." }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Accès refusé.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: "Suppression d'un article avec succès." }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Accès refusé.' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
