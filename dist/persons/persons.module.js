...
const adresses_service_1 = require("../adresses/adresses.service");
const prisma_service_1 = require("../prisma/prisma.service");
let PersonsModule = class PersonsModule {
};
PersonsModule = __decorate([
    (0, common_1.Module)({
        providers: [persons_resolver_1.PersonsResolver, persons_service_1.PersonsService, adresses_service_1.AdressesService, prisma_service_1.PrismaService]
    })
], PersonsModule);
